...
if(!$_SESSION['id_usuario']){
    ...
    $query = "SELECT nombre_usuario, nombre, email, direccion FROM usuario WHERE id_tipouser=2";//se crea la consulta para la generacion del reporte
    ...
    $pdf->Cell(30);//celda
    $pdf->Cell(130,10,'Reporte de clientes',1,0,'C');//titulo del reporte
    $pdf->ln(10);//salto de linea
    $pdf->cell(115,10,'generado por:'.$_SESSION['nombre_usuario'],0,1,'R');// se manda  allamr al usuario que este dentro
    $pdf->Cell(30);//celda
    $pdf->Cell(65,6,date('l, d/m/Y'),1,0,'C',2);//se define la fecha en que se genero el reporte
	...
	$pdf->Cell(45,6,'Nombre de usuario',1,0,'C',2);
    $pdf->Cell(45,6,'Nombres del cliente',1,0,'C',2);
    $pdf->Cell(45,6,'Direccion del cliente',1,0,'C',2);
    $pdf->Cell(45,6,'Email del cliente',1,1,'C',2);
