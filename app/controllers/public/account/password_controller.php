                    ...
                    if($usuario->checkPassword()){
                        if($_POST['clave_nueva_1'] == $_POST['clave_nueva_2']){
                            if($usuario->setClave($_POST['clave_nueva_1'])){
                                ...
                                throw new Exception("Clave nueva incorrecta, debe poseer al menos una minuscula, una mayuscula, un numero, un caracter especial y debe de ser mayor a 8 caracteres");
                            }
                        }else{
...
require_once("../app/views/public/account/password_view.php");
?>