<div class="row">
        ...
        print("
                            ...
                            <div class='col s12m4 l4'>
                                <img class='col s4 m12 l12 materialboxed border' src='../web/img/productos/".$Producto->getFoto2()."' width='100'>
                                    <img class='col s4 m12 l12 materialboxed border' src='../web/img/productos/".$Producto->getFoto3()."' width='100'>
                                        <img class='col s4 m12 l12 materialboxed border' src='../web/img/productos/".$Producto->getFoto4()."' width='100'>
                                        </img>
                                    </img>
                                </img>
                            </div>
                        ...
                        <h5 class='container'> califica este producto</h5>
                        <div class='col s6 offset-s2 star'>
                            ...
                            <input class='validate' id='icon_prefix' type='number' max='5' min='1' step='any'>
                            </input>
                        </div>
                            </h5>
                        </div>
                        <div class='input-field col s10 offset-s1'>
                            ...
                            <a class='waves-effect waves-light btn tooltipped pink darken-4' data-delay='50' data-position='top' data-tooltip='Añadir comentario' href='Carrito.php'>
                        ...
                        <div class='col s6'>
                            <form>
                                <div class='row'>
                                    <!--Input numérico-->
                                    <div class='input-field col s8'>
                                    <input class='validate' id='icon_prefix' type='number' min='1' step='any'>
                                        </input>
                                    </div>
                                </div>
                            </form>
